...
public class MainActivity extends AppCompatActivity {
    ...
    private void createCollection() {
        String[] samsungModels = {"Samsung Galaxy M21","Samsung Galaxy M51","Samsung Galaxy F41","Samsung Galaxy A50s"};

        String[] googleModels = {"Pixel 4 XL","Pixel 3a","Pixel 3a XL","Pixel 2","Pixel 3"};
        ...
        String[] motorolaModels = {"Motorola One Fusion+","Motorola E7 Plus","Motorola 09"};
